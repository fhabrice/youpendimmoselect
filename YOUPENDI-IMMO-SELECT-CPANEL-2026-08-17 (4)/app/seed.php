...
function seed_demo(): void
{
    ...
    $props = [
        ...
        [
            ...
            'rent' => 285000, 'deposit' => 0, 'bedrooms' => 5, 'bathrooms' => 4, 'area' => 380,
            'furnished' => 1, 'status' => 'disponible', 'owner' => $owner2, 'apporteur' => $agent2,
            'img' => 'p2.jpg', 'usage' => 'residentiel', 'offre' => 'vente',
        ...
        [
            ...
            'rent' => 175000, 'deposit' => 0, 'bedrooms' => 6, 'bathrooms' => 4, 'area' => 420,
            'furnished' => 0, 'status' => 'visite_en_cours', 'owner' => $owner2, 'apporteur' => $agent1,
            'img' => 'p6.jpg', 'usage' => 'residentiel', 'offre' => 'vente',
    ...
    foreach ($props as $i => $p) {
        $pid = db()->insert('properties', [
            ...
            'status' => $p['status'],
            'offre' => $p['offre'] ?? 'location_mensuelle',
